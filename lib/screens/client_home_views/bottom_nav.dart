      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          children: [
            ...
            _NavItem(icon: Icons.person_rounded, label: 'PERFIL', active: currentIndex == 2, onTap: () => onChanged(2)),
            _NavItem(icon: Icons.directions_car_rounded, label: 'GARAGE', active: currentIndex == 3, onTap: () => onChanged(3)),
            _NavItem(icon: Icons.history_rounded, label: 'HISTORIAL', active: currentIndex == 4, onTap: () => onChanged(4)),
            _NavItem(icon: Icons.payments_rounded, label: 'PAGOS', active: currentIndex == 5, onTap: () => onChanged(5)),
            _NavItem(icon: Icons.receipt_long_rounded, label: 'COTIZ.', active: currentIndex == 6, onTap: () => onChanged(6)),
          ],
        ),
      ),
    );
